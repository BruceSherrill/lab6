...
$images = array();
$images[1] = array("id"=>22,"title" => "View of Cologne", "description" => "View of Cologne from atop the Cologne Cathedral", "country" => "Germany", "city" => "Cologne", "user" => "Joao Fernandes", "path" => "6114850721.jpg", "taken" => "August 8, 2017", "tags" => array("cathedral","high","birds-eye"));

$images[2] = array("id"=>54,"title" => "Arch of Septimus Severus", "description" => "In the Roman Forum", "country" => "Italy", "city" => "Rome", "user" => "Ellie Sullivan", "path" => "9495574327.jpg", "taken" => "August 15, 2017", "tags" => array("rome","ruins","ancient","assassinated"));

$images[3] = array("id"=>7,"title" => "Lunenburg Port", "description" => "On board a small sailing ship leaving Lunenburg", "country" => "Canada", "city" => "Lunenburg", "user" => "Mark Taylor", "path" => "5856697109.jpg", "taken" => "August 28, 2017", "tags" => array("maritimes","nova scotia","yacht","port"));

$images[4] = array("id"=>19,"title" => "British Museum", "description" => "The library in the British Museum in London", "country" => "United Kingdom", "city" => "London", "user" => "Mark Taylor", "path" => "5855729828.jpg", "taken" => "September 3, 2017", "tags" => array("museum","karl marx","reading room","shadows","yellow"));
